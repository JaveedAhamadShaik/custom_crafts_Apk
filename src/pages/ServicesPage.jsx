...
import { Calendar, Clock, Car, Palette, Shield, Wrench } from 'lucide-react';
  ...
  const services = [
    {
      ...
      image: 'Professional vehicle wrap installation in modern garage',
    },
    {
      id: 2,
      icon: Shield,
      ...
      image: 'Paint protection film being applied to luxury car',
    },
    {
      id: 3,
      icon: Palette,
      ...
      image: 'Designer creating custom vehicle graphics on computer',
    },
    {
      id: 4,
      icon: Wrench,
      ...
      image: 'Technician carefully installing vehicle wrap',
    },
  ];
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="h-64 bg-secondary relative overflow-hidden">
                <img  class="w-full h-full object-cover" alt={service.title} src="https://images.unsplash.com/photo-1595872018818-97555653a011" />
