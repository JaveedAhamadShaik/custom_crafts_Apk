  ...
  const products = [
    {
      ...
      name: 'Custom T-Shirt',
      price: 499,
      image: 'High-quality custom printed t-shirt with vibrant colors',
    ...
    },
    {
      ...
      name: 'Custom Hoodie',
      price: 999,
      image: 'Comfortable custom hoodie with personalized graphics',
          ...
          {products.map((product, index) => (
            ...
            >
              <div className="relative h-80 bg-secondary overflow-hidden">
                <img  class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" alt={product.name} src="https://images.unsplash.com/photo-1635865165118-917ed9e20936" />
